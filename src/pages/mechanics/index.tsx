...
import { getMechanics, deleteMechanicById } from 'apiSdk/mechanics';
...
export function MechanicListPage(props: MechanicListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<MechanicInterface>>(
    () => `/mechanics?params=${JSON.stringify(params)}`,
    fetcher,
  );
