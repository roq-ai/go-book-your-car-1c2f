...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Go Book Your Car Services`}</title>

        <meta
          name="description"
          content="Experience the future of vehicle servicing with Go Book Your Car Services. MyCar, your city's first and largest provider, brings car service and repair right to your doorstep. Save time, stay comfortable."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1487754180451-c456f719a1fc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMjBzZXJ2aWNlfGVufDB8fHx8MTY5NjM5NDQ0OHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Go Book Your Car Services`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of vehicle servicing with Go Book Your Car Services. MyCar, your city's first and largest provider, brings car service and repair right to your doorstep. Save time, stay comfortable.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Service Manager" type="service-manager" abilities={appConfig.ownerAbilities} />
