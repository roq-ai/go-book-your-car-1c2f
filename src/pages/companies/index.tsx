...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'mechanic.count', 'service.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('mechanic', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'mechanic',
          header: 'Mechanic',
          accessorKey: 'mechanic',
          cell: ({ row: { original: record } }: any) => record?._count?.mechanic,
        }
      : null,
