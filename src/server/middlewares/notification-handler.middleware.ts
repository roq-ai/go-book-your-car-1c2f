...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Service Request.create': { roles: ['service-manager'], key: 'service_request', tenantPath: [], userPath: [] },
  'Service Request Update.update': {
    roles: ['service-manager', 'mechanic'],
    key: 'service_update',
    tenantPath: [],
    userPath: [],
  },
  'Service Request Completion.update': {
...
const ownerRoles: string[] = ['service-manager'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['service-manager', 'mechanic'];
